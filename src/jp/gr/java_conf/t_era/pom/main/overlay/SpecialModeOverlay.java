...
public class SpecialModeOverlay implements OverlayDrawing {
	...
	static {
		try {
			DEFENCE = ImageIO.read(ClassLoader.getSystemResourceAsStream("jp\\gr\\java_conf\\t_era\\pom\\image\\Shield.gif"));
			ATTACK = ImageIO.read(ClassLoader.getSystemResourceAsStream("jp\\gr\\java_conf\\t_era\\pom\\image\\Fire.gif"));
